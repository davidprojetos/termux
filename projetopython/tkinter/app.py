...
class ComputadorInterface(tk.Tk):
    ...
    def adicionar_arquivo(self):
        if self.computador is None:
            messagebox.showerror("Erro", "Por favor, ligue o computador primeiro.")
            return

        nome = simpledialog.askstring("Adicionar Arquivo", "Digite o nome do arquivo:")
        if nome:
            tamanho = simpledialog.askinteger("Adicionar Arquivo", "Digite o tamanho do arquivo em GB:")
    ...
    def deletar_arquivo(self):
        ...
        nome = simpledialog.askstring("Deletar Arquivo", "Digite o nome do arquivo a ser deletado:")
        if nome:
