...
jdk_dir="/data/data/com.termux/files/usr/lib/jvm/java-17-openjdk"

print_info "Updating ide-environment.properties..."
print_info "JAVA_HOME=$jdk_dir"
echo ""
props_dir="/data/data/com.termux/files/usr/etc"
...
if [ ! -e $props ]; then
    ...
    if is_yes "$props file already exists. Would you like to overwrite it?"; then
        ...
        print_err "Manually edit /data/data/com.termux/files/usr/etc/ide-environment.properties file and set JAVA_HOME and ANDROID_SDK_ROOT."
    fi
fi
